/* EJ03.04
Pasar la posición del vértice al shader de fragmentos y pintar ese valor.
Entender el significado y cómo se interpola, y escribir una breve descripción detallándolo.
*/
