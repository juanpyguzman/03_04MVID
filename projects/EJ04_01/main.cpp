/*EJ04.01 - Pintar un quad con la mezcla de una textura con los atributos de color interpolados de cada vértice.
*/
...
int main(int, char* []) {
	...
	const Shader shader("../projects/EJ04_01/vertex.vs", "../projects/EJ04_01/fragment.fs");
