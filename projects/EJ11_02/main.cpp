/*
Modelo de iluminación Blinn, crear una escena con un suelo y cuatro quads perpendiculares alineados,
uno detrás de otro. Uno de ellos usa mapas difusos y speculares para pintarse solido.
Los otros tres se pintan de un color plano, uno rojo, otro verde y otro azul,
...
void render(const Geometry& quad, const Shader& s_phong, const Shader& s_blend,
    ...
    for (int i = 0; i < 3; i++)
    {
        ...
        s_blend.set("material.alpha", 0.25f*(3-i));
