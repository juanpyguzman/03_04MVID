/* EJ03.02
Cambiar el color del triángulo con el paso del tiempo, usando un uniform para ello
y la función glfwGetTime(), que mide el tiempo que ha transcurrido desde que se inició GLFW.
*/
...
void render(uint32_t VAO, const Shader& shader) {
	...
	shader.use();
	shader.set("time", static_cast<float>(glfwGetTime()));
