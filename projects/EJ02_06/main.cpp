/* EJ02.06
Pintar el mismo hexágono, pero generando los vértices de manera procedural
(usando algún tipo de algoritmo), mediante coordenadas polares.
*/
...
uint32_t createVertexData(uint32_t* VBO, uint32_t* EBO) {
	...
	for (int i = 0; i < 6; i++) {
		vertices[3 * i + 3] = 1 * cos(i * PI / 3.0);
		vertices[3 * i + 4] = 1 * sin(i * PI / 3.0);
		vertices[3 * i + 5] = 0.0f;
	}
